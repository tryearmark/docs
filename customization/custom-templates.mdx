...
`Copy link` creates a live shared link for that template.

- Anyone with the link can open it
- If you update the template later, those changes are reflected through the same link
- You can turn link sharing off later from the share settings
