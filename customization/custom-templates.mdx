...
description: "Create custom meeting templates in Earmark for yourself or your workspace, share them with a link, and use them from the picker or slash commands."
  ...
  >
    ...
    >
      <video
        ...
        title="Fullscreen composer menu showing the Save as template option."
        style={{ width: '100%', display: 'block' }}
      />
    </div>
  </div>
