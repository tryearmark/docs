...
description: "Turn a design or feature conversation into a working prototype the same day by converting the meeting into a detailed prompt for an AI prototyping tool."
...
This guide is a specific instance of the [workflows](/workflows) pattern, applied to the loop from feature conversation to working prototype. It builds on what the [v0](/integrations/overview#v0), [Cursor](/integrations/overview#cursor), and [Codex](/integrations/overview#codex) integration pages each describe for one tool, generalized to the workflow shape.
...
| [v0](/integrations/overview#v0) | Web components, React, Tailwind-style UIs | React / Next.js code |
...
| [Cursor](/integrations/overview#cursor) / [Codex](/integrations/overview#codex) | Coded prototypes, technical exploration | Code in any framework |
...
- [v0 integration](/integrations/overview#v0) — the single-tool version of this workflow for v0
- [Cursor integration](/integrations/overview#cursor) — the single-tool version for Cursor
- [Codex integration](/integrations/overview#codex) — the single-tool version for Codex
- [Linear integration](/integrations/overview#linear) — for spinning up tickets from the prototype review
