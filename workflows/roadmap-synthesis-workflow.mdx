...
**Source discussions:** {List with Earmark links}
**Last updated:** {date}
**Next review:** {date}
...
- **Source:** Earmark link if applicable
...
- Related PRDs
- Related ADRs
- Source customer corpus (Earmark links)
- Source strategy discussions (Earmark links)
```
...
- New source meetings since the last update (Earmark links / pasted
  artifacts)
...
## Change log — {Date}
**Source:** New meetings since {previous update date} — {Earmark links}
