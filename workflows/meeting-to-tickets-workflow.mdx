...
description: "Turn engineering discussions, customer escalations, and design reviews into tracker-ready tickets with the context sprint planning needs."
...
This guide is a specific instance of the [workflows](/workflows) pattern, applied to the meeting → tracker bridge. It builds on the [Linear integration](/integrations/overview#linear) and the built-in `Ticket Generator` template — generalizing to multiple ticket types (story, spike, bug report, epic) for any tracker your team works out of.
...
| --- | --- |
| [Linear](/integrations/overview#linear) | Issue (default), with labels for type — feature, bug, spike, chore, improvement |
...
- [Linear integration](/integrations/overview#linear) — the single-tool version of this workflow for Linear
- [Cursor integration](/integrations/overview#cursor) — for tickets that flow into coded prototypes
