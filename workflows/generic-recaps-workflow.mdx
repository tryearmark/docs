...
description: "Turn any meeting into a readable recap with Earmark, learn what makes a recap useful, and know when to switch to a more specialized workflow."
...
<Tip>
These templates recap one meeting. For a recap that spans several — your week, or every call with one customer — ask [Chat](/earmark-basics/chat) instead: *"Give me a recap of my meetings this week,"* or the **This week's recap** suggestion on the Chat home page. It cites the meetings it drew from.
</Tip>
...
- [Command menu](/earmark-basics/meeting-history#search-with-the-command-menu) — for finding past recaps with full-text search
- The full specialized workflow set:
  ...
  - [Ad-hoc Q&A](/workflows/ad-hoc-qa-workflow) — for asking questions of one meeting or many
