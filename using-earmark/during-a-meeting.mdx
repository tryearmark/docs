...
description: "Use Earmark in a live meeting: watch artifacts update in real time, use live templates and slash commands, pin moments, and ask Chat questions."
...
## Ask Chat about the meeting

Click **Chat** in the meeting header to ask questions while the meeting is live: "What's being discussed right now?" or "Did this come up in the previous meeting?" Chat reads the conversation so far and can pull in your earlier meetings. See [Chat](/earmark-basics/chat).
...
When the call is over, the desktop app ends the recording on its own. See [Auto-end](/earmark-basics/auto-end).
