...
When something lands in the conversation — a decision, a risk, a quote you need later — drop a [pin](/earmark-basics/pins) instead of breaking focus to take notes. Earmark saves that moment so you can turn it into a focused artifact after the call.
