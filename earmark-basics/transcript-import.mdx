...
description: "Import a transcript from another tool to create an Earmark meeting. Set its date, search it, and generate artifacts like any recorded meeting."
keywords:
  [
    "import transcript",
    "transcript import",
...
<Note>
Imported meetings behave identically to recorded ones. They appear in your meeting history at the date you set, are searchable from the [command menu](/earmark-basics/meeting-history#search-with-the-command-menu), and accept artifacts, templates, and tasks like any other meeting.
</Note>
