---
title: "Templates"
description: "Browse Earmark's 30+ built-in meeting templates by use case and role, and insert them with slash commands for faster, more consistent artifacts."
...
<Frame caption="Templates button above the prompt bar">
  ...
  >
    ...
    >
      <img
        src="/images/template-button.png"
        alt="Meeting toolbar showing the Templates button above the prompt bar."
...
<Frame caption="Slash command menu for templates in the prompt bar">
  ...
  >
    ...
    >
      <img
        src="/images/template-shortcut-engineering-spec.png"
        alt="Prompt bar with slash command open and inline template suggestions filtered for engineering spec."
        style={{ width: '100%', display: 'block' }}
      />
    </div>
  </div>
