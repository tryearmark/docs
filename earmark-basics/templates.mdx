...
If built-in templates don't cover your workflow, we can build a custom task agent that generates artifacts in your exact format. Send us a structure, example, or checklist and we'll configure a template that produces the output your team needs.

See [Custom templates](/customization/custom-templates) for how to request one.
