...
description: "Turn meetings into AI artifacts like summaries, PRDs, tickets, and follow-ups. Learn how tasks create artifacts, live updates, and the default summary."
...
## Every meeting gets a summary

The first time you stop a meeting, Earmark adds a **Real-Time Meeting Summary and Action Items** task for you, so every meeting ends with something useful. If you've already added a summary task, Earmark skips this one. [Temporary meetings](/earmark-basics/temporary-meetings) get the same default task.
