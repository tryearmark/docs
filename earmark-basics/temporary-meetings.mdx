...
<Frame caption="Workspace setting to enforce temporary meetings">
  ...
  >
    ...
    >
      <img
        src="/images/settings-workspace-enforce-temporary-mode.png"
        alt="Settings Workspace section showing the enforce temporary meetings toggle for the workspace."
