...
description: "Save every Earmark meeting as a local Markdown file so AI agents like Claude Code, Codex, and Cursor can use your meeting context. Desktop only."
keywords:
  [
    "local transcripts",
    "markdown files",
