---
title: "Workspaces"
description: "Set up an Earmark workspace for your team: invite members, manage roles, set your company vision, check single sign-on, and manage billing."
...
<Frame caption="Invite teammates by email and role">
  ...
  >
    ...
    >
      <img
        src="/images/settings-invite-users.png"
        alt="Invite users dialog with email fields and member or admin role selection."
...
<Frame caption="Settings > Workspace name, logo, and policies">
  ...
  >
    ...
    >
      <img
        src="/images/settings-workspace-logo-name.png"
        alt="Workspace settings showing workspace name, logo upload, and related workspace-level options."
        style={{ width: '100%', display: 'block' }}
      />
    </div>
  </div>
...
- **Temporary meetings**: turn on **Require temporary mode** to make every new meeting temporary (see [Temporary meetings](/earmark-basics/temporary-meetings))
- **Single sign-on**: see whether single sign-on is set up for your workspace, and contact us to set it up
...
<Note>
Meetings are private to the person who recorded them. Workspace membership shares the workspace itself, its members, and its settings, not each other's meetings. To share meeting context with teammates, add meetings to a [project](/earmark-basics/projects) and share it.
</Note>
