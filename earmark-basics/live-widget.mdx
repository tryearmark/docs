...
description: "The Live Widget is a floating desktop control that shows your recording is active and lets you pin moments. Learn how to turn it on in Settings."
...
It's off by default. Turn it on in **Settings > Capture**.

<Note>
Capture settings apply **per machine**. Turning on the Live Widget on your laptop doesn't turn it on on your desktop.
</Note>
...
| --- | --- | --- |
| Live Widget | Yes, when turned on in **Settings > Capture** | Not available |
| Global pin shortcut | Yes, configurable | Not available |
| **Pin** button in the meeting command bar | Yes | Yes |
