...
description: "Fix Earmark data not updating, meetings not syncing, or the app stuck loading. See which domains and WebSocket connections your network must allow."
...
<Note>
Earmark detects a stuck connection after your computer wakes, reconnects to the internet, or has been in the background for a while, and reloads itself once. If the app still looks stale after that, refresh it and check the network settings below.
</Note>
