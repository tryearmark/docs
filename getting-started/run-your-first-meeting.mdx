...
description: "A step-by-step walkthrough of your first Earmark meeting: start recording, follow the live transcript, generate an artifact, and share it."
...
When the meeting ends, stop recording. On desktop, Earmark [ends the recording for you](/earmark-basics/auto-end) if you forget. Earmark generates a title automatically from the transcript. Review your artifact and make any edits.
</Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Search past meetings" icon="magnifying-glass" href="/earmark-basics/meeting-history#search-with-the-command-menu">
    Use Cmd+K to find any meeting, artifact, or discussion.
  </Card>
  <Card title="Ask about your meetings" icon="comments" href="/earmark-basics/chat">
    Ask Chat questions across all your meetings and get answers with sources.
  </Card>
  <Card title="Organize with projects" icon="folder" href="/earmark-basics/projects">
    Group related meetings and share them with your team.
  </Card>
</CardGroup>
...
- [ ] Stop recording when the meeting ends (on desktop, auto-end does this for you)
