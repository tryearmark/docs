...
description: "Compare the Earmark desktop app and web app: system audio capture, calendar integration, notifications, and what's different on macOS and Windows."
...
This means Earmark can transcribe both sides of a conversation when you're on a video call in Zoom, Google Meet, Teams, or any other app. Earmark keeps the two streams separate, so the transcript shows what you said apart from what everyone else said.
...
- **Menu bar countdown**: displays your next meeting title and a live countdown timer directly in the macOS menu bar. It's on by default. Turn it off with **Show countdown** in **Settings > Calendar**.
